  ...
  ngAfterContentInit(): void {
    this.movables.changes.subscribe(() => {
      ...
      this.movables.forEach(movable => {
        this.subscriptions.push(movable.touchStart.subscribe(() => this.measureBoundaries(movable)));
        this.subscriptions.push(movable.touchMove.subscribe(() => this.maintainBoundaries(movable)));
      });
    });
